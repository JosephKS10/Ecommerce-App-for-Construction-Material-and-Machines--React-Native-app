...
export default function ConstructionMaterialInfoScreen() {
      ...
      <View className="relative mt-5">
              ...
              <View 
                ...
                <View className="px-5">
                    ...
                    {/* Add to Cart Button */}
                    <TouchableOpacity onPress={handleAddToCart} style={{ backgroundColor: 'black', padding: 10, width: "32%", flexDirection: 'row', alignItems: 'center', justifyContent: "center"}}>
                  ...
                  <DropdownSlider question="Dimensions"
                  specifications={{
                              Length: item.props.dimensions.Length,
                              Width: item.props.dimensions.Width,
                              Height: item.props.dimensions.Height
                            }}/>
                  </View>
