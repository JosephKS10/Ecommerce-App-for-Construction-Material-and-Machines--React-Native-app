...
export default function HomeScreen() {
  ...
  <View style={styles.searchContainer}>
    ...
    <TextInput placeholder='Search Construction Materials' style={styles.searchInput} keyboardType='default'/>
  </View>

  <TouchableOpacity onPress={handleCartPress} style={styles.iconContainer}>
    <Icon.ShoppingCart height={20} width={20} strokeWidth="2.5" stroke="white" />
  </TouchableOpacity>
</View>
