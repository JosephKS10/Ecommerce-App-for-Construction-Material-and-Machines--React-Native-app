...
export default function MachineMaterialInfoScreen() {

  const {params} = useRoute();
  let item = params
  console.log(item.props.companyImageUrl)
  ...
  return (
    <View>
      ...
      <View className="relative mt-5">
                <Image source={{uri: item.props.companyImageUrl}} style={{width:"100%",height:200}}/>
                <TouchableOpacity 
              ...
              <View 
                style={{borderTopLeftRadius: 40, borderTopRightRadius: 40, marginTop:10}} className="bg-white -mt-12 pt-4">
                <View className="px-5">
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', width:"48%", padding: 10, justifyContent:"center", borderWidth:1}}>
                    ...
                    <TouchableOpacity onPress={handleBuyNow} style={{ backgroundColor: '#1687E0', padding: 10, width: "48%", flexDirection: 'row', alignItems: 'center', justifyContent: "center"}}>
                      <Text style={{ color: 'white', fontSize: 22 }}>Hire Now</Text>
                    </TouchableOpacity>
                    {showNotification && <CartNotification message="Item added to cart" />}
                  </View>

                  
                  <View className="py-3" style={{paddingBottom:60, borderBottomLeftRadius:40, borderBottomRightRadius:40}}>
                  <Text className="font-bold underline"style={{paddingTop:10,paddingBottom:15, fontSize:20,}}>Product Info</Text>
                  <DropdownSlider question="Specifications"
                  specifications={{
                              Weight: item.props.specifications.Weight,
                              Strength: item.props.specifications.Strength,
                              Usage: item.props.specifications.Usage
                            }}/>
                  <DropdownSlider question="Features"
                  specifications={{
                              1: item.props.features[0],
                              2: item.props.features[1],
                              3: item.props.features[2]
                            }}/>
